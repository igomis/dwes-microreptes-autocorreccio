...
Si no existeix `docs/r1-ampliacio.md` però detectes una segona pàgina o ruta pròpia, navegació, contingut adaptat i proves concretes, conserva una candidatura positiva basada en eixes evidències. Marca `core_ready` segons l'estat real del nucli i indica l'absència de declaració com a comprovació pendent; no convertisques automàticament la candidatura en 0. El professorat decidirà si la valida després de la defensa.
