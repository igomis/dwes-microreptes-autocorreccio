...
Avalua `r2-s07-primera-peca-testable-poo-composer` només amb evidencies del repositori.

Comprova que el canvi parteix d'un flux provat en `R2M6` i introdueix una primera peça testable: `composer.json` o alternativa equivalent justificada, autoload, una classe simple del domini o servei i una prova unitària mínima.
...
Marca revisio docent si no hi ha evidència clara de Composer/autoload, classe pròpia, execucio de prova o manteniment del flux.
