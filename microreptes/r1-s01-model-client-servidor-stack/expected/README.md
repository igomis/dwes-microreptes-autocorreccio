...
Este microrepte espera evidències documentals, no encara una aplicació backend executable.

Evidències mínimes:

- fitxa breu d'exploració tècnica inicial o document equivalent;
- explicació aplicada del model client/servidor del producte;
