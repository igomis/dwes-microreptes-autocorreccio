...
- el paper del client i del servidor en el producte de l'alumne;
...
No demanes encara un servidor executable ni un punt d'entrada funcional: això pertany a MP2 i MP3. Penalitza que l'alumne entregue només una comparativa genèrica de tecnologies, captures de converses amb IA o una decisió sense relació amb el producte propi.
