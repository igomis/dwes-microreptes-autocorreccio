...
Avalua `r3-s01-arrencada-nou-projecte` només amb evidencies del repositori.

Comprova que hi ha un projecte en framework arrancable, amb Docker o entorn equivalent documentat, `.env.example` o instruccions sense secrets, i una ruta inicial o `healthcheck` funcional.
