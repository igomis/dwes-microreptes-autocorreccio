  ...
  return [
    {
      ...
      content: [
        ...
        'En traçabilitat, usa commit_evidence.history i active_microrepte_candidates. Valora la seqüència real, els missatges i els fitxers, no només el nombre de commits. Un únic commit no implica zero: dona puntuació parcial si és descriptiu i hi ha README, proves o registre equivalent. Reserva la puntuació màxima per a diversos commits útils d’inici, progrés i prova/tancament, o un registre equivalent especialment clar.',
